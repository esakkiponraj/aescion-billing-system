...
export const AuthLayout: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-3 sm:p-4 relative overflow-hidden">
      ...
      <div className="flex items-center gap-3 mb-6 sm:mb-8 z-10">
        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-brand-600 flex items-center justify-center shadow-lg shadow-brand-500/20">
      ...
      <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-6 text-xs text-slate-500 z-10 text-center">
